package com.fancy.customwidget.widget;
...
import com.fancy.customwidget.R;
...
public class ValidText extends View {
    ...
    public ValidText(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        for (int i = 0; i < arrayLength; i++) {
            ...
            switch (attr) {
                case R.styleable.ValidText_android_textSize:
                    textSize = (int) typedArray.getDimension(attr, 40);
                    break;

                case R.styleable.ValidText_android_clickable:
                    clickable = typedArray.getBoolean(attr, true);
                    break;

                /*case R.styleable.ValidText_android_background:
                    background = Color.parseColor(typedArray.getString(attr));
                    break;*/
            }
        }
